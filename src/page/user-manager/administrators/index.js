     ...
     <div className="mt-3 border-lightgray  py-2 px-2 ">
         <div className="d-lg-flex justify-content-between">
             <div className="d-flex align-items-center">
                 ...
                 <div className="ms-1">
                     <h6 className="text-danger fs-12 mb-0 ads-bg rounded-pill px-2 py-1">{(administratorsList && administratorsList?.total_records) ? administratorsList.total_records:'N/a'} Users</h6>
                 </div>
             </div>
             <div>
